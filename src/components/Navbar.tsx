        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-display font-bold text-sm tracking-wider text-foreground text-glow-cyan leading-tight">
                play.pixelvalley.fun
              </span>
              <a
                href="https://discord.gg/x7QFZNat"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1 text-[11px] font-heading text-muted-foreground hover:text-[#5865F2] transition-colors mt-0.5"
              >
